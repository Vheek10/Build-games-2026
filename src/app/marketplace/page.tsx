...
export default function MarketplacePage() {
  ...
  return (
    <div className="min-h-screen mt-20 bg-linear-to-b from-gray-50 to-white font-montserrat">
          ...
          <div className="md:hidden mb-6">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-3 bg-white border border-gray-200 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-red-500 font-montserrat"
              />
              {searchQuery && (
                <button
