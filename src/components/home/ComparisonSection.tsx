...
export default function ComparisonSection() {
  ...
  return (
    <section
      className="relative py-10 sm:py-14 lg:py-20 bg-gray-50 overflow-hidden"
      ...
      <div className="max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex justify-center gap-3 sm:gap-6 mb-12 sm:mb-16 flex-wrap">
          {comparisons.map((_, idx) => (
            ...
            >
              <div
                className={`text-[9px] sm:text-[10px] font-black uppercase tracking-[0.2em] sm:tracking-[0.3em] transition-all duration-500 ${
                  active === idx
        ...
        <div className="relative max-w-5xl mx-auto">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="relative rounded-2xl border border-gray-100 shadow-lg overflow-hidden cursor-default group/card min-h-[480px] sm:min-h-[520px] lg:min-h-[550px] bg-white"
            >
              ...
              <div className="relative z-10 p-6 sm:p-10 lg:p-24 grid lg:grid-cols-[1.1fr_0.9fr] gap-8 sm:gap-12 lg:gap-20 items-center">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-10">
                    {comparisons[active].metrics.map((m, i) => (
                      <div key={i} className="group/metric">
                        ...
                        <p className="lg:text-2xl text-lg font-bold text-gray-900 tracking-tighter">
                          {m.value}
                        </p>
                      </div>
                    ))}
                ...
                <div className="relative">
                  <div className="space-y-6 p-6 sm:p-8 lg:p-10 rounded-2xl bg-white/40 border border-gray-100 backdrop-blur-2xl shadow-xl shadow-red-900/5">
                    <div className="mb-6">
