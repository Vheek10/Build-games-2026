    ...
    >
      <div className="max-w-7xl px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        >
          ...
          >
            We aren&apos;t just building a platform; we&apos;re establishing the
            legal and social protocols for the global RealFi economy.
          </motion.p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 mb-24 sm:mb-32">
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-2xl group cursor-default shadow-[0_50px_100px_-20px_rgba(0,0,0,0.15)] bg-gray-900 h-[520px] sm:h-[600px] lg:h-[750px]"
          >
            ...
            <div className="absolute inset-0 p-8 sm:p-10 lg:p-24 flex flex-col justify-end z-10">
              <div className="relative">
                ...
                <h3 className="text-2xl sm:text-3xl lg:text-5xl font-black text-white mb-6 sm:mb-8 tracking-tightest leading-[0.95] sm:leading-[0.9] capitalize">
                  Our <br />
            ...
            {[
              ...
              return (
                <motion.div
                  ...
                  className="group p-6 sm:p-8 lg:p-10 bg-gray-50 rounded-2xl border border-gray-100 hover:border-red-100 hover:bg-white hover:shadow-[0_40px_80px_-15px_rgba(37,99,235,0.1)] transition-all duration-700"
                >
                  <div className="w-16 h-16 rounded-xl bg-white shadow-xl flex items-center justify-center mb-10 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
