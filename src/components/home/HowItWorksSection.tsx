...
const steps = [
	...
	},
	{
		...
		bgColor: "bg-gradient-to-br from-blue-900/20 to-emerald-900/10",
		iconBg: "bg-gradient-to-r from-blue-500 to-emerald-400",
		stats: [
			{ label: "Blockchain Network", value: "OnChain", icon: Globe },
			{ label: "Global Access", value: "24/7", icon: Globe },
		],
		glowColor: "before:from-blue-500/20 before:to-emerald-500/20",
		image:
	...
	},
	{
		...
		bgColor: "bg-gradient-to-br from-cyan-900/20 to-blue-900/10",
		...
		glowColor: "before:from-cyan-500/20 before:to-blue-500/20",
		image:
...
export default function HowItWorksSection() {
	...
	return (
		<section className="relative py-24 lg:py-32 px-4 sm:px-6 bg-gradient-to-b from-gray-900 via-gray-900/50 to-gray-900 overflow-hidden">
			{/* Background Elements */}
			<div className="absolute inset-0 overflow-hidden">
				<div className="absolute -top-40 -right-40 w-80 h-80 bg-blue-500/5 rounded-full blur-3xl" />
				<div className="absolute -bottom-40 -left-40 w-80 h-80 bg-cyan-500/5 rounded-full blur-3xl" />
				<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-96 bg-gradient-to-r from-blue-500/5 via-transparent to-cyan-500/5 blur-3xl" />
			</div>

			<div className="relative max-w-7xl mx-auto">
				{/* Section Header */}
				<div className="text-center mb-20">
					<div className="inline-flex items-center justify-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-2xl mb-8 backdrop-blur-sm border border-blue-500/20">
					...
					<div className="max-w-4xl mx-auto">
						<h2 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-8 leading-tight">
							...
							<span className="relative inline-block">
								<span className="bg-gradient-to-r from-blue-400 via-cyan-300 to-emerald-300 bg-clip-text text-transparent animate-gradient">
									StrataDeed
								</span>
								<span className="absolute -inset-1 bg-gradient-to-r from-blue-600 via-cyan-500 to-emerald-400 blur-2xl opacity-30 -z-10 rounded-lg" />
							</span>{" "}
							Works
						</h2>
				...
				<div className="mb-24">
					<div className="relative group">
						...
						<div className="relative bg-gray-900/80 backdrop-blur-xl rounded-2xl overflow-hidden border border-gray-700/50 shadow-2xl">
							<div className="grid lg:grid-cols-2 gap-0 min-h-[600px]">
								...
								<div className="relative overflow-hidden order-1 lg:order-1">
									...
									<div className="absolute bottom-8 left-8 right-8">
										<div className="bg-black/80 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/50">
									...
									<div className="absolute bottom-1/3 left-1/4 w-2 h-2 bg-cyan-500 rounded-full animate-ping delay-300" />
								...
								<div className="p-8 lg:p-12 order-2 lg:order-2 flex flex-col justify-center">
									...
									<div className="mb-10 lg:mb-12">
											...
											{steps.map((step, index) => {
												...
												return (
													<button
														...
														{/* Step Circle */}
														<div
															className={`relative mb-3 w-12 h-12 rounded-full flex items-center justify-center transition-all duration-500 ${
																isActive
																	? step.iconBg
																	: isCompleted
																	? step.iconBg
														...
														{isActive && (
															<div className="absolute -top-1.5 left-1/2 -translate-x-1/2 w-2 h-2 rounded-full bg-white border-2 border-blue-500 shadow-sm" />
														)}
													</button>
												);
											})}
										...
										<div className="relative h-1 bg-gray-800 rounded-full overflow-hidden">
											<div
												className={`absolute top-0 left-0 h-full ${currentStep.color.replace(
													"from-",
													"bg-gradient-to-r from-",
									...
									<div
										...
										<div className="space-y-6 pt-6">
											...
											<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
												{currentStep.keyPoints.map((point, index) => (
													<div
														key={index}
														className="group/item relative p-4 rounded-xl bg-gray-800/50 border border-gray-700 hover:border-blue-500/50 transition-all duration-300 hover:shadow-lg">
										...
										{/* Stats */}
										<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 pt-8 border-t border-gray-700">
											{currentStep.stats.map((stat, index) => {
												const StatIcon = stat.icon;
												return (
													<div
														key={index}
														className="text-center p-4 lg:p-6 rounded-xl bg-gray-800/50 border border-gray-700 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
							...
							<div className="absolute bottom-6 right-6 flex items-center gap-3">
								<button
									...
									className="group p-3 lg:p-4 rounded-full bg-gray-800/90 backdrop-blur-sm border border-gray-600 disabled:opacity-30 disabled:cursor-not-allowed hover:bg-gray-700 hover:shadow-xl transition-all duration-300 hover:scale-110">
									<ArrowLeftCircle className="w-6 h-6 lg:w-7 lg:h-7 text-gray-300 group-hover:text-blue-400 group-hover:scale-110 transition-transform" />
								</button>
								<button
									onClick={nextStep}
									disabled={activeStep === steps.length - 1}
									className="group p-3 lg:p-4 rounded-full bg-gray-800/90 backdrop-blur-sm border border-gray-600 disabled:opacity-30 disabled:cursor-not-allowed hover:bg-gray-700 hover:shadow-xl transition-all duration-300 hover:scale-110">
									<ArrowRightCircle className="w-6 h-6 lg:w-7 lg:h-7 text-gray-300 group-hover:text-blue-400 group-hover:scale-110 transition-transform" />
								</button>
							</div>
				...
				<div className="relative mb-24">
					<div className="relative bg-gradient-to-br from-gray-900 via-black to-gray-900 rounded-3xl p-8 lg:p-12 overflow-hidden">
						{/* Animated Background */}
						<div className="absolute inset-0">
							<div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_30%,rgba(96,165,250,0.1),transparent_50%)]" />
						...
						<div className="relative grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
							<div className="space-y-6 lg:space-y-8">
								...
								<p className="text-lg lg:text-xl text-gray-300 leading-relaxed">
									...
									permanently recorded on the OnChain blockchain, ensuring
								...
								<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 pt-4">
									...
									<div className="bg-white/5 backdrop-blur-sm rounded-2xl p-5 lg:p-6 border border-white/10 hover:border-white/20 transition-all duration-300">
										<Zap className="w-9 h-9 lg:w-10 lg:h-10 text-blue-400 mb-3 lg:mb-4" />
										<div className="text-2xl lg:text-3xl font-bold text-white">
											&lt;2s
										</div>
										<div className="text-sm text-gray-300 font-medium mt-2">
							...
							<div className="relative">
								...
								<div className="relative transform perspective-1000 rotate-y-3 lg:rotate-y-6">
									<div className="bg-gradient-to-br from-blue-900/50 to-cyan-900/50 backdrop-blur-xl rounded-2xl p-6 lg:p-8 border border-white/10 shadow-2xl">
				...
				<div className="text-center">
					...
					<div className="flex flex-col sm:flex-row gap-4 lg:gap-6 justify-center items-center">
						...
						<button className="px-8 lg:px-12 py-4 lg:py-5 bg-transparent border-2 border-gray-700 hover:border-blue-400 text-gray-300 hover:text-white font-semibold rounded-xl lg:rounded-2xl hover:shadow-lg transform hover:scale-105 transition-all duration-300 backdrop-blur-sm w-full sm:w-auto">
							Schedule a Demo
						</button>
					</div>

					<div className="mt-8 lg:mt-12 flex flex-col sm:flex-row items-center justify-center gap-4 lg:gap-8 text-gray-500">
						<div className="flex items-center gap-3">
