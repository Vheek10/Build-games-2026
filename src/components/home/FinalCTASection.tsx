...
import { ArrowUpRight, Shield, CheckCircle, Zap, Globe } from "lucide-react";
...
export default function FinalCTASection() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative py-10 sm:py-16 lg:py-24 overflow-hidden text-white"
      style={{
        backgroundImage:
          "linear-gradient(to bottom, rgba(0,0,0,0.7), rgba(0,0,0,0.8)), url('/images/unsplash-c627a92ad1ab.jpg')",
          ...
          <motion.div className="relative">
            ...
            <div className="flex justify-center mb-12">
              ...
              >
                ...
                <span className="text-[9px] sm:text-[10px] font-black text-red-100 uppercase tracking-[0.3em] sm:tracking-[0.5em] font-montserrat">
                  Future of Ownership
                </span>
            ...
            >
              <motion.h2
                ...
                className="text-3xl sm:text-4xl lg:text-7xl font-black text-white mb-8 sm:mb-10 leading-[1.05] tracking-tightest font-mclaren"
              >
              ...
              <motion.p
                ...
                className="text-sm lg:text-lg text-gray-300 max-w-2xl mx-auto font-medium leading-relaxed font-montserrat"
              >
                No hidden processes. No manual errors. No silent title issues.
                Just secure, transparent, and accessible real estate ownership
                for everyone.
              </motion.p>
            </div>
            {/* Benefits Grid */}
            ...
            >
              {benefits.map((benefit, idx) => (
                <motion.div
                  ...
                  className="group p-6 sm:p-8 bg-white/20 border border-gray-100 rounded-2xl hover:bg-white hover:border-red-100 backdrop-blur-xl transition-all duration-500 text-center shadow-sm hover:shadow-xl hover:shadow-red-900/5"
                >
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
                {[
                  ...
                  <div key={i} className="text-center group">
                    ...
                    <h4 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white tracking-widest group-hover:text-red-400 transition-colors uppercase font-mclaren">
                      {s.value}
                    </h4>
                  </div>
                ))}
